...
class PS5OdriveNode(Node):
    def __init__(self):
        ...
        # Subscribers
        self.button_sub = self.create_publisher(Bool, 'button_o', self.button_callback, 10)
        self.stick_sub= self.create_publisher(Float32, 'left_stick_y', self.joy_callback, 10)
