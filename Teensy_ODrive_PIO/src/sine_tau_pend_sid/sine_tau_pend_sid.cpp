...
OdriveSinusoidTorqueSID st_sid_runs[n_runs] = {
    ...
    { {1.5*SINE_TORQUE_BASE_AMP, 1.5*SINE_TORQUE_BASE_AMP/2}, {1.0, 2.0}, 10, 2}, // Good at flipping
    ...
    { {SINE_TORQUE_BASE_AMP, SINE_TORQUE_BASE_AMP/2}, {1.0, 2.0}, 10, 2}, // Good at flipping
